...
// source: enigma/insurance/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "enigma.insurance.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("enigma/insurance/v1beta1/genesis.proto", fileDescriptor_293324fee7d3f3b1)
}
