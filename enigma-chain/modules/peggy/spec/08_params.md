...
Enigma Chain validators decided to use the same Ethereum keys for another chain
...
These values are the average Enigma Chain block time and Ethereum block time respectively
