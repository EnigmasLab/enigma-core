...
func NewBlacklistEthereumAddressesProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx peggy blacklist-ethereum-addresses-proposal blacklistaddr1,blacklistaddr2 --title="Blacklist Ethereum Addresses." --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
...
func NewRevokeEthereumBlacklistProposalCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle revoke-blacklist-ethereum-addresses-proposal blacklistaddr1,blacklistaddr2 --title="revoke Blacklist Ethereum Addresses" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
