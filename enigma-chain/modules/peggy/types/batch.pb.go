...
// source: enigma/peggy/v1/batch.proto
...
func init() {
	proto.RegisterType((*OutgoingTxBatch)(nil), "enigma.peggy.v1.OutgoingTxBatch")
	proto.RegisterType((*OutgoingTransferTx)(nil), "enigma.peggy.v1.OutgoingTransferTx")
}

func init() { proto.RegisterFile("enigma/peggy/v1/batch.proto", fileDescriptor_48fd09581f1b5901) }
