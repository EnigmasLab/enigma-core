...
// source: enigma/peggy/v1/attestation.proto
...
func init() {
	proto.RegisterEnum("enigma.peggy.v1.ClaimType", ClaimType_name, ClaimType_value)
	proto.RegisterType((*Attestation)(nil), "enigma.peggy.v1.Attestation")
	proto.RegisterType((*ERC20Token)(nil), "enigma.peggy.v1.ERC20Token")
}

func init() {
	proto.RegisterFile("enigma/peggy/v1/attestation.proto", fileDescriptor_3022043570947e1e)
}
