...
// source: enigma/peggy/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "enigma.peggy.v1.GenesisState")
}

func init() { proto.RegisterFile("enigma/peggy/v1/genesis.proto", fileDescriptor_3b8a70f18b346efa) }
