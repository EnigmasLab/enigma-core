...
var (
	pattern_Msg_ValsetConfirm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "valset_confirm"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_SendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_RequestBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "request_batch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_ConfirmBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "confirm_batch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_DepositClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "deposit_claim"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_WithdrawClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "withdraw_claim"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_ValsetUpdateClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "valset_updated_claim"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_ERC20DeployedClaim_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "erc20_deployed_claim"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_SetOrchestratorAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "set_orchestrator_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_CancelSendToEth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "cancel_send_to_eth"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_SubmitBadSignatureEvidence_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"enigma", "peggy", "v1", "submit_bad_signature_evidence"}, "", runtime.AssumeColonVerbOpt(false)))
)
