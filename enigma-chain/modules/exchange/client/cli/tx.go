...
import (
	...
	cliflags "github.com/EnigmasLab/enigma-core/cli/flags"
	...
	"github.com/EnigmasLab/enigma-core/enigma-chain/version"
)
...
func NewCreateSpotLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = "enigmad tx exchange create-spot-limit-order buy ETH/USDT 2.4 2000.1 --from=genesis --keyring-backend=file --yes"
	return cmd
}
...
func NewCancelSpotLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = "enigmad tx exchange cancel-spot-limit-order ETH/USDT 0xc66d1e52aa24d16eaa8eb0db773ab019e82daf96c14af0e105a175db22cd0fc8"
	return cmd
}
...
func NewCreateDerivativeLimitOrderTxCmd() *cobra.Command {
	...
	cmd.Example = `enigmad tx exchange create-derivative-limit-order \
			--order-type="buy" \
			--market-id="ETH/USDT" \
...
func NewExchangeEnableProposalTxCmd() *cobra.Command {
	...
	cmd.Example = `tx exchange spot --title="Enable Spot Exchange" --description="Enable Spot Exchange" --deposit="1000000000000000000fury"`
	cliflags.AddGovProposalFlags(cmd)
	return cmd
}
...
func NewExpiryFuturesMarketLaunchProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		$ %s tx exchange propose-expiry-futures-market \
			...
			--min-price-tick-size="0.0001" \
			--min-quantity-tick-size="0.001" \
			--title="FURY/ATOM expiry futures market" \
			--description="XX" \
			--deposit="1000000000000000000fury" \
			--from=genesis \
			--keyring-backend=file \
		...
		$ %s tx exchange trading-reward-points-update-proposal \
			...
			Where proposal.json contains:
			{
				...
				"reward_point_updates": [
					{
						"account_address": "fury1wfawuv6fslzjlfa4v7exv27mk6rpfeyvhvxchc",
  ...
  "proposals": [
    {
      "title": "title",
      "description": "description",
      "recipient": "fury1dzqd00lfd4y4qy2pxa0dsdwzfnmsu27hgttswz",
      "amount": [
        {
          "denom": "fury",
          "amount": "1000000"
...
Example:
$ %s tx gov batch-exchange-modifications-proposal --proposal="path/to/proposal.json" --from=mykey --deposit=1000000fury
...
func NewDerivativeMarketParamUpdateProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		$ %s tx exchange update-derivative-market-params \
			...
			--market-status="Active" \
			--title="FURY derivative market params update" \
			--description="XX" \
			--deposit="1000000000000000000fury" \
			--from=genesis \
			--keyring-backend=file \
...
func NewSubaccountTransferTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange subaccount-transfer 0x90f8bf6a479f320ead074411a4b0e7944ea8c9c1000000000000000000000001 0x90f8bf6a479f320ead074411a4b0e7944ea8c9c1000000000000000000000002 10000fury --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewDepositTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange deposit 10000fury 0xc6fe5d33615a1c52c08018c47e8bc53646a0e101000000000000000000000001 --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewWithdrawTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange withdraw 10000fury --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewExternalTransferTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange external-transfer 0x90f8bf6a479f320ead074411a4b0e7944ea8c9c1000000000000000000000001 10000fury --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewAuthzTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange authz fury1jcltmuhplrdcwp7stlr4hlhlhgd4htqhe4c0cs 0xc6fe5d33615a1c52c08018c47e8bc53646a0e101000000000000000000000000 MsgCreateSpotLimitOrder 0xa508cb32923323679f29a032c70342c147c17d0145625922b0ef22e955c844c0  --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewBatchUpdateAuthzTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx exchange authz batch-update fury1jcltmuhplrdcwp7stlr4hlhlhgd4htqhe4c0cs 0xc6fe5d33615a1c52c08018c47e8bc53646a0e101000000000000000000000000 0xa508cb32923323679f29a032c70342c147c17d0145625922b0ef22e955c844c0 0xfd30930cb70d176c37d0c405cde055e551c5b1116b7049a88bcf821766b62d62 --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
