...
func GetQueryCmd() *cobra.Command {
	...
	cmd.AddCommand(
		...
		GetEthAddressFromFuryAddressCmd(),
		GetFuryAddressFromEthAddressCmd(),
		GetSubaccountIDFromFuryAddressCmd(),
...
// GetEthAddressFromFuryAddressCmd returns the Enigma address for an account given its hex-encoded Ethereum address
func GetEthAddressFromFuryAddressCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "eth-address-from-fury-address [Enigma address]",
		Short: "Returns the Ethereum address given an fury-prefixed Cosmos address",
		Long:  "Returns the Ethereum address given an fury-prefixed Cosmos address",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
// GetSubaccountIDFromFuryAddressCmd returns the default subaccount ID for an account given its FURY address
func GetSubaccountIDFromFuryAddressCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "subaccount-id-from-fury-address [Enigma address]",
		Short: "Returns the default Subaccount ID given an fury-prefixed Cosmos address",
		Long:  "Returns the default Subaccount ID given an fury-prefixed Cosmos address",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
// GetFuryAddressFromEthAddressCmd returns the Ethereum address for an account given its FURY address
func GetFuryAddressFromEthAddressCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "fury-address-from-eth-address [Ethereum address]",
		Short: "Returns the FURY address given an hex-encoded Ethereum address",
		Long:  "Returns the FURY address given an hex-encoded Ethereum address",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
