...
// GetFuryRewardStakedRequirementThreshold returns the staked requirement threshold
func (k *Keeper) GetFuryRewardStakedRequirementThreshold(ctx sdk.Context) sdkmath.Int {
	defer metrics.ReportFuncCallAndTiming(k.svcTags)()

	return k.GetParams(ctx).FuryRewardStakedRequirementThreshold
}
