...
const (
	...
	// SpotMarketInstantListingFee is 1000 FURY
	SpotMarketInstantListingFee int64 = 1000

	// DerivativeMarketInstantListingFee is 1000 FURY
	DerivativeMarketInstantListingFee int64 = 1000

	// BinaryOptionsMarketInstantListingFee is 100 FURY
...
var (
	...
	KeyFuryRewardStakedRequirementThreshold         = []byte("KeyFuryRewardStakedRequirementThreshold")
...
func NewParams(
	...
	furyRewardStakedRequirementThreshold sdkmath.Int,
	...
	return Params{
		...
		FuryRewardStakedRequirementThreshold:         furyRewardStakedRequirementThreshold,
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyFuryRewardStakedRequirementThreshold, &p.FuryRewardStakedRequirementThreshold, validateFuryRewardStakedRequirementThreshold),
...
func DefaultParams() Params {
	return Params{
		SpotMarketInstantListingFee:                 sdk.NewCoin("fury", sdkmath.NewIntWithDecimal(SpotMarketInstantListingFee, 18)),
		DerivativeMarketInstantListingFee:           sdk.NewCoin("fury", sdkmath.NewIntWithDecimal(DerivativeMarketInstantListingFee, 18)),
		...
		FuryRewardStakedRequirementThreshold:         sdkmath.NewIntWithDecimal(100, 18), // 100 FURY
		TradingRewardsVestingDuration:               604800,                             // 7 days
		LiquidatorRewardShareRate:                   sdk.NewDecWithPrec(5, 2),           // 5% liquidator reward
		BinaryOptionsMarketInstantListingFee:        sdk.NewCoin("fury", sdkmath.NewIntWithDecimal(BinaryOptionsMarketInstantListingFee, 18)),
...
func (p Params) Validate() error {
	...
	if err := validateFuryRewardStakedRequirementThreshold(p.FuryRewardStakedRequirementThreshold); err != nil {
		return fmt.Errorf("fury_reward_staked_requirement_threshold is incorrect: %w", err)
	}
...
func validateFuryRewardStakedRequirementThreshold(i interface{}) error {
	v, ok := i.(sdkmath.Int)
	if !ok {
		return fmt.Errorf("invalid parameter type: %T", i)
	}
	...
	if v.IsZero() {
		return fmt.Errorf("FuryRewardStakedRequirementThreshold cannot be zero: %d", v)
	}

	if v.IsNegative() {
		return fmt.Errorf("FuryRewardStakedRequirementThreshold cannot be negative: %d", v)
	}
