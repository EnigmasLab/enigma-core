...
type EnigmaAction interface {
	// ValidateBasic does a simple validation check that
	// doesn't require access to any other information.
	ValidateBasic() error
}

func ParseRequest(data []byte) (EnigmaAction, error) {
	...
	return nil, errors.Wrap(sdkerrors.ErrUnknownRequest, "unknown variant of EnigmaAction")
}
