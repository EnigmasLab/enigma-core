...
// source: enigma/exchange/v1beta1/exchange.proto

package types

import (
	fmt "fmt"
	types1 "github.com/EnigmasLab/enigma-core/enigma-chain/modules/oracle/types"
...
type Params struct {
	// spot_market_instant_listing_fee defines the expedited fee in FURY required
	...
	// derivative_market_instant_listing_fee defines the expedited fee in FURY
	...
	// fury_reward_staked_requirement_threshold defines the threshold on FURY
	// rewards after which one also needs staked FURY to receive more
	FuryRewardStakedRequirementThreshold github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,15,opt,name=fury_reward_staked_requirement_threshold,json=furyRewardStakedRequirementThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"fury_reward_staked_requirement_threshold"`
	...
	// binary_options_market_instant_listing_fee defines the expedited fee in FURY
	// required to create a derivative market by bypassing governance
	...
	AtomicMarketOrderAccessLevel AtomicMarketOrderAccessLevel `protobuf:"varint,19,opt,name=atomic_market_order_access_level,json=atomicMarketOrderAccessLevel,proto3,enum=enigma.exchange.v1beta1.AtomicMarketOrderAccessLevel" json:"atomic_market_order_access_level,omitempty"`
...
type DerivativeMarket struct {
	...
	// Oracle type
	OracleType types1.OracleType `protobuf:"varint,4,opt,name=oracle_type,json=oracleType,proto3,enum=enigma.oracle.v1beta1.OracleType" json:"oracle_type,omitempty"`
	...
	Status MarketStatus `protobuf:"varint,14,opt,name=status,proto3,enum=enigma.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
// An object describing a binary options market in Enigma Protocol.
...
type SpotMarket struct {
	...
	MarketId string `protobuf:"bytes,7,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	// Status of the market
	Status MarketStatus `protobuf:"varint,8,opt,name=status,proto3,enum=enigma.exchange.v1beta1.MarketStatus" json:"status,omitempty"`
...
type SpotOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,3,opt,name=order_type,json=orderType,proto3,enum=enigma.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotLimitOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,2,opt,name=order_type,json=orderType,proto3,enum=enigma.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
...
type SpotMarketOrder struct {
	...
	// order types
	OrderType OrderType `protobuf:"varint,4,opt,name=order_type,json=orderType,proto3,enum=enigma.exchange.v1beta1.OrderType" json:"order_type,omitempty"`
	// trigger_price is the trigger price used by stop/take orders
...
func init() {
	proto.RegisterEnum("enigma.exchange.v1beta1.AtomicMarketOrderAccessLevel", AtomicMarketOrderAccessLevel_name, AtomicMarketOrderAccessLevel_value)
	proto.RegisterEnum("enigma.exchange.v1beta1.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterEnum("enigma.exchange.v1beta1.OrderType", OrderType_name, OrderType_value)
	proto.RegisterEnum("enigma.exchange.v1beta1.ExecutionType", ExecutionType_name, ExecutionType_value)
	proto.RegisterEnum("enigma.exchange.v1beta1.OrderMask", OrderMask_name, OrderMask_value)
	proto.RegisterType((*Params)(nil), "enigma.exchange.v1beta1.Params")
	proto.RegisterType((*MarketFeeMultiplier)(nil), "enigma.exchange.v1beta1.MarketFeeMultiplier")
	proto.RegisterType((*DerivativeMarket)(nil), "enigma.exchange.v1beta1.DerivativeMarket")
	proto.RegisterType((*BinaryOptionsMarket)(nil), "enigma.exchange.v1beta1.BinaryOptionsMarket")
	proto.RegisterType((*ExpiryFuturesMarketInfo)(nil), "enigma.exchange.v1beta1.ExpiryFuturesMarketInfo")
	proto.RegisterType((*PerpetualMarketInfo)(nil), "enigma.exchange.v1beta1.PerpetualMarketInfo")
	proto.RegisterType((*PerpetualMarketFunding)(nil), "enigma.exchange.v1beta1.PerpetualMarketFunding")
	proto.RegisterType((*DerivativeMarketSettlementInfo)(nil), "enigma.exchange.v1beta1.DerivativeMarketSettlementInfo")
	proto.RegisterType((*NextFundingTimestamp)(nil), "enigma.exchange.v1beta1.NextFundingTimestamp")
	proto.RegisterType((*MidPriceAndTOB)(nil), "enigma.exchange.v1beta1.MidPriceAndTOB")
	proto.RegisterType((*SpotMarket)(nil), "enigma.exchange.v1beta1.SpotMarket")
	proto.RegisterType((*Deposit)(nil), "enigma.exchange.v1beta1.Deposit")
	proto.RegisterType((*SubaccountTradeNonce)(nil), "enigma.exchange.v1beta1.SubaccountTradeNonce")
	proto.RegisterType((*OrderInfo)(nil), "enigma.exchange.v1beta1.OrderInfo")
	proto.RegisterType((*SpotOrder)(nil), "enigma.exchange.v1beta1.SpotOrder")
	proto.RegisterType((*SpotLimitOrder)(nil), "enigma.exchange.v1beta1.SpotLimitOrder")
	proto.RegisterType((*SpotMarketOrder)(nil), "enigma.exchange.v1beta1.SpotMarketOrder")
	proto.RegisterType((*DerivativeOrder)(nil), "enigma.exchange.v1beta1.DerivativeOrder")
	proto.RegisterType((*SubaccountOrderbookMetadata)(nil), "enigma.exchange.v1beta1.SubaccountOrderbookMetadata")
	proto.RegisterType((*SubaccountOrder)(nil), "enigma.exchange.v1beta1.SubaccountOrder")
	proto.RegisterType((*SubaccountOrderData)(nil), "enigma.exchange.v1beta1.SubaccountOrderData")
	proto.RegisterType((*DerivativeLimitOrder)(nil), "enigma.exchange.v1beta1.DerivativeLimitOrder")
	proto.RegisterType((*DerivativeMarketOrder)(nil), "enigma.exchange.v1beta1.DerivativeMarketOrder")
	proto.RegisterType((*Position)(nil), "enigma.exchange.v1beta1.Position")
	proto.RegisterType((*MarketOrderIndicator)(nil), "enigma.exchange.v1beta1.MarketOrderIndicator")
	proto.RegisterType((*TradeLog)(nil), "enigma.exchange.v1beta1.TradeLog")
	proto.RegisterType((*PositionDelta)(nil), "enigma.exchange.v1beta1.PositionDelta")
	proto.RegisterType((*DerivativeTradeLog)(nil), "enigma.exchange.v1beta1.DerivativeTradeLog")
	proto.RegisterType((*SubaccountPosition)(nil), "enigma.exchange.v1beta1.SubaccountPosition")
	proto.RegisterType((*SubaccountDeposit)(nil), "enigma.exchange.v1beta1.SubaccountDeposit")
	proto.RegisterType((*DepositUpdate)(nil), "enigma.exchange.v1beta1.DepositUpdate")
	proto.RegisterType((*PointsMultiplier)(nil), "enigma.exchange.v1beta1.PointsMultiplier")
	proto.RegisterType((*TradingRewardCampaignBoostInfo)(nil), "enigma.exchange.v1beta1.TradingRewardCampaignBoostInfo")
	proto.RegisterType((*CampaignRewardPool)(nil), "enigma.exchange.v1beta1.CampaignRewardPool")
	proto.RegisterType((*TradingRewardCampaignInfo)(nil), "enigma.exchange.v1beta1.TradingRewardCampaignInfo")
	proto.RegisterType((*FeeDiscountTierInfo)(nil), "enigma.exchange.v1beta1.FeeDiscountTierInfo")
	proto.RegisterType((*FeeDiscountSchedule)(nil), "enigma.exchange.v1beta1.FeeDiscountSchedule")
	proto.RegisterType((*FeeDiscountTierTTL)(nil), "enigma.exchange.v1beta1.FeeDiscountTierTTL")
	proto.RegisterType((*VolumeRecord)(nil), "enigma.exchange.v1beta1.VolumeRecord")
	proto.RegisterType((*AccountRewards)(nil), "enigma.exchange.v1beta1.AccountRewards")
	proto.RegisterType((*TradeRecords)(nil), "enigma.exchange.v1beta1.TradeRecords")
	proto.RegisterType((*SubaccountIDs)(nil), "enigma.exchange.v1beta1.SubaccountIDs")
	proto.RegisterType((*TradeRecord)(nil), "enigma.exchange.v1beta1.TradeRecord")
	proto.RegisterType((*Level)(nil), "enigma.exchange.v1beta1.Level")
	proto.RegisterType((*AggregateSubaccountVolumeRecord)(nil), "enigma.exchange.v1beta1.AggregateSubaccountVolumeRecord")
	proto.RegisterType((*AggregateAccountVolumeRecord)(nil), "enigma.exchange.v1beta1.AggregateAccountVolumeRecord")
	proto.RegisterType((*MarketVolume)(nil), "enigma.exchange.v1beta1.MarketVolume")
	proto.RegisterType((*DenomDecimals)(nil), "enigma.exchange.v1beta1.DenomDecimals")
}

func init() {
	proto.RegisterFile("enigma/exchange/v1beta1/exchange.proto", fileDescriptor_2116e2804e9c53f9)
}

var fileDescriptor_2116e2804e9c53f9 = []byte{
	// 4092 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if !this.FuryRewardStakedRequirementThreshold.Equal(that1.FuryRewardStakedRequirementThreshold) {
		return false
	}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.FuryRewardStakedRequirementThreshold.Size()
		i -= size
		if _, err := m.FuryRewardStakedRequirementThreshold.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintExchange(dAtA, i, uint64(size))
	}
...
func (m *Params) Size() (n int) {
	...
	l = m.FuryRewardStakedRequirementThreshold.Size()
	n += 1 + l + sovExchange(uint64(l))
	if m.TradingRewardsVestingDuration != 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FuryRewardStakedRequirementThreshold", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FuryRewardStakedRequirementThreshold.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:
