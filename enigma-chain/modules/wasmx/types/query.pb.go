...
// source: enigma/wasmx/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryWasmxParamsRequest)(nil), "enigma.wasmx.v1.QueryWasmxParamsRequest")
	proto.RegisterType((*QueryWasmxParamsResponse)(nil), "enigma.wasmx.v1.QueryWasmxParamsResponse")
	proto.RegisterType((*QueryModuleStateRequest)(nil), "enigma.wasmx.v1.QueryModuleStateRequest")
	proto.RegisterType((*QueryModuleStateResponse)(nil), "enigma.wasmx.v1.QueryModuleStateResponse")
	proto.RegisterType((*QueryContractRegistrationInfoRequest)(nil), "enigma.wasmx.v1.QueryContractRegistrationInfoRequest")
	proto.RegisterType((*QueryContractRegistrationInfoResponse)(nil), "enigma.wasmx.v1.QueryContractRegistrationInfoResponse")
}

func init() { proto.RegisterFile("enigma/wasmx/v1/query.proto", fileDescriptor_660c5209971a3cd4) }
...
func (c *queryClient) WasmxParams(ctx context.Context, in *QueryWasmxParamsRequest, opts ...grpc.CallOption) (*QueryWasmxParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Query/WasmxParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ContractRegistrationInfo(ctx context.Context, in *QueryContractRegistrationInfoRequest, opts ...grpc.CallOption) (*QueryContractRegistrationInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Query/ContractRegistrationInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) WasmxModuleState(ctx context.Context, in *QueryModuleStateRequest, opts ...grpc.CallOption) (*QueryModuleStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Query/WasmxModuleState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_WasmxParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Query/WasmxParams",
	}
...
func _Query_ContractRegistrationInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Query/ContractRegistrationInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_WasmxModuleState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Query/WasmxModuleState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "enigma.wasmx.v1.Query",
	...
	Metadata: "enigma/wasmx/v1/query.proto",
}
