...
// source: enigma/wasmx/v1/events.proto
...
func init() {
	proto.RegisterType((*EventContractExecution)(nil), "enigma.wasmx.v1.EventContractExecution")
}

func init() { proto.RegisterFile("enigma/wasmx/v1/events.proto", fileDescriptor_f2ba06c5f04cb490) }
