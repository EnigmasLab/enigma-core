...
// source: enigma/wasmx/v1/proposal.proto
...
type ContractRegistrationRequest struct {
	...
	FundingMode FundingMode `protobuf:"varint,9,opt,name=funding_mode,json=fundingMode,proto3,enum=enigma.wasmx.v1.FundingMode" json:"funding_mode,omitempty"`
}
...
func init() {
	proto.RegisterEnum("enigma.wasmx.v1.FundingMode", FundingMode_name, FundingMode_value)
	proto.RegisterType((*ContractRegistrationRequestProposal)(nil), "enigma.wasmx.v1.ContractRegistrationRequestProposal")
	proto.RegisterType((*BatchContractRegistrationRequestProposal)(nil), "enigma.wasmx.v1.BatchContractRegistrationRequestProposal")
	proto.RegisterType((*BatchContractDeregistrationProposal)(nil), "enigma.wasmx.v1.BatchContractDeregistrationProposal")
	proto.RegisterType((*ContractRegistrationRequest)(nil), "enigma.wasmx.v1.ContractRegistrationRequest")
	proto.RegisterType((*BatchStoreCodeProposal)(nil), "enigma.wasmx.v1.BatchStoreCodeProposal")
}

func init() { proto.RegisterFile("enigma/wasmx/v1/proposal.proto", fileDescriptor_ba51f3e994cc61a5) }
