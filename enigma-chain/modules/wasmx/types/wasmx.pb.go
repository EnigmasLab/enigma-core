...
// source: enigma/wasmx/v1/wasmx.proto
...
type RegisteredContract struct {
	...
	// funding mode
	FundMode FundingMode `protobuf:"varint,7,opt,name=fund_mode,json=fundMode,proto3,enum=enigma.wasmx.v1.FundingMode" json:"fund_mode,omitempty"`
}
...
func init() {
	proto.RegisterType((*Params)(nil), "enigma.wasmx.v1.Params")
	proto.RegisterType((*RegisteredContract)(nil), "enigma.wasmx.v1.RegisteredContract")
}

func init() { proto.RegisterFile("enigma/wasmx/v1/wasmx.proto", fileDescriptor_6818ff331f2cddc4) }
