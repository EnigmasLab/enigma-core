...
// source: enigma/wasmx/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgExecuteContractCompat)(nil), "enigma.wasmx.v1.MsgExecuteContractCompat")
	proto.RegisterType((*MsgExecuteContractCompatResponse)(nil), "enigma.wasmx.v1.MsgExecuteContractCompatResponse")
	proto.RegisterType((*MsgUpdateContract)(nil), "enigma.wasmx.v1.MsgUpdateContract")
	proto.RegisterType((*MsgUpdateContractResponse)(nil), "enigma.wasmx.v1.MsgUpdateContractResponse")
	proto.RegisterType((*MsgActivateContract)(nil), "enigma.wasmx.v1.MsgActivateContract")
	proto.RegisterType((*MsgActivateContractResponse)(nil), "enigma.wasmx.v1.MsgActivateContractResponse")
	proto.RegisterType((*MsgDeactivateContract)(nil), "enigma.wasmx.v1.MsgDeactivateContract")
	proto.RegisterType((*MsgDeactivateContractResponse)(nil), "enigma.wasmx.v1.MsgDeactivateContractResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "enigma.wasmx.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "enigma.wasmx.v1.MsgUpdateParamsResponse")
	proto.RegisterType((*MsgRegisterContract)(nil), "enigma.wasmx.v1.MsgRegisterContract")
	proto.RegisterType((*MsgRegisterContractResponse)(nil), "enigma.wasmx.v1.MsgRegisterContractResponse")
}

func init() { proto.RegisterFile("enigma/wasmx/v1/tx.proto", fileDescriptor_f7afe23baa925f70) }
...
func (c *msgClient) UpdateRegistryContractParams(ctx context.Context, in *MsgUpdateContract, opts ...grpc.CallOption) (*MsgUpdateContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/UpdateRegistryContractParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ActivateRegistryContract(ctx context.Context, in *MsgActivateContract, opts ...grpc.CallOption) (*MsgActivateContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/ActivateRegistryContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeactivateRegistryContract(ctx context.Context, in *MsgDeactivateContract, opts ...grpc.CallOption) (*MsgDeactivateContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/DeactivateRegistryContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ExecuteContractCompat(ctx context.Context, in *MsgExecuteContractCompat, opts ...grpc.CallOption) (*MsgExecuteContractCompatResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/ExecuteContractCompat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RegisterContract(ctx context.Context, in *MsgRegisterContract, opts ...grpc.CallOption) (*MsgRegisterContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/enigma.wasmx.v1.Msg/RegisterContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateRegistryContractParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/UpdateRegistryContractParams",
	}
...
func _Msg_ActivateRegistryContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/ActivateRegistryContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeactivateRegistryContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/DeactivateRegistryContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ExecuteContractCompat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/ExecuteContractCompat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RegisterContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enigma.wasmx.v1.Msg/RegisterContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "enigma.wasmx.v1.Msg",
	...
	Metadata: "enigma/wasmx/v1/tx.proto",
}
