...
// source: enigma/auction/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "enigma.auction.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("enigma/auction/v1beta1/genesis.proto", fileDescriptor_56f095f457353f49)
}
