...
// source: enigma/auction/v1beta1/auction.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "enigma.auction.v1beta1.Params")
	proto.RegisterType((*Bid)(nil), "enigma.auction.v1beta1.Bid")
	proto.RegisterType((*EventBid)(nil), "enigma.auction.v1beta1.EventBid")
	proto.RegisterType((*EventAuctionResult)(nil), "enigma.auction.v1beta1.EventAuctionResult")
	proto.RegisterType((*EventAuctionStart)(nil), "enigma.auction.v1beta1.EventAuctionStart")
}

func init() {
	proto.RegisterFile("enigma/auction/v1beta1/auction.proto", fileDescriptor_49edfee5f1ef4b5a)
}
