...
This proposal is to add a band oracle request into the list. When this is accepted, enigma chain fetches one more price info from bandchain.
...
This proposal is to enable IBC connection between Band chain and Enigma chain.
