...
func NewGrantPriceFeederPrivilegeProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle grant-price-feeder-privilege-proposal base quote relayer1,relayer2 --title="grant price feeder privilege" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
...
func NewRevokePriceFeederPrivilegeProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle revoke-price-feeder-privilege-proposal base quote relayer1,relayer2 --title="revoke price feeder privilege" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewGrantBandOraclePrivilegeProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle grant-band-oracle-privilege-proposal relayer1,relayer2 --title="grant band oracle privilege" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewRevokeBandOraclePrivilegeProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle revoke-band-oracle-privilege-proposal relayer1,relayer2 --title="revoke band oracle privilege" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewRelayPriceFeedPriceTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle relay-price-feed-price fury usdt 25.00 --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func NewEnableBandIBCProposalTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example:
		$ %s tx oracle enable-band-ibc-proposal true 10 --port-id "oracle" --channel "channel-0" --ibc-version "bandchain-1" --title="Enable Band IBC with a request interval of 10 blocks" --description="XX" --deposit="1000000000000000000fury" --from=genesis --keyring-backend=file --yes
		`,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
