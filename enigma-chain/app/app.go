...
import (
	...
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/auction"
	auctionkeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/auction/keeper"
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/insurance"
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/ocr"
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/oracle"
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/wasmx"
	"github.com/EnigmasLab/enigma-core/enigma-chain/wasmbinding"
	...
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/peggy"
	peggyKeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/peggy/keeper"
	peggytypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/peggy/types"
	...
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/tokenfactory"
	tokenfactorykeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/tokenfactory/keeper"
	tokenfactorytypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/tokenfactory/types"
	...
	_ "github.com/EnigmasLab/enigma-core/client/docs/statik"

	"github.com/EnigmasLab/enigma-core/enigma-chain/app/ante"
	auctiontypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/auction/types"
	"github.com/EnigmasLab/enigma-core/enigma-chain/modules/exchange"
	...
	insurancekeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/insurance/keeper"
	insurancetypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/insurance/types"
	ocrkeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/ocr/keeper"
	ocrtypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/ocr/types"
	oraclekeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/oracle/keeper"
	oracletypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/oracle/types"
	wasmxkeeper "github.com/EnigmasLab/enigma-core/enigma-chain/modules/wasmx/keeper"
	wasmxtypes "github.com/EnigmasLab/enigma-core/enigma-chain/modules/wasmx/types"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".enigmad")
}

const appName = "enigmad"
...
var _ runtime.AppI = (*EnigmaApp)(nil)

// var _ server.Application (*EnigmaApp)(nil)

// EnigmaApp implements an extended ABCI application.
...
// NewEnigmaApp returns a reference to a new initialized Enigma application.
func NewEnigmaApp(
	logger log.Logger,
	db dbm.DB,
	...
	// NOTE we use custom Enigma transaction decoder that supports the sdk.Tx interface instead of sdk.StdTx
	...
	availableCapabilities := "iterator,staking,stargate,cosmwasm_1_1,cosmwasm_1_2,enigma"
	...
	// use Enigma's custom AnteHandler
	app.SetAnteHandler(
		ante.NewAnteHandler(
...
func (app *EnigmaApp) GetIBCKeeper() *ibckeeper.Keeper { return app.IBCKeeper }

func (app *EnigmaApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

func (app *EnigmaApp) GetTxConfig() client.TxConfig { return MakeEncodingConfig().TxConfig }
...
func (app *EnigmaApp) RegisterNodeService(clientCtx client.Context) {
...
// LegacyAmino returns EnigmaApp's amino codec.
//
...
// AppCodec returns EnigmaApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns EnigmaApp's InterfaceRegistry
...
func (app *EnigmaApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

func (app *EnigmaApp) GetStakingKeeper() ibctestingtypes.StakingKeeper {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *EnigmaApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *EnigmaApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *EnigmaApp) registerUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(upgradeName,
		func(ctx sdk.Context, _ upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
			...
			tenFURY, ok := sdk.NewIntFromString("10000000000000000000")
			if !ok {
				panic("NewIntFromString failed for 10000000000000000000")
			}
			fee := sdk.NewCoin(chaintypes.EnigmaCoin, tenFURY)
