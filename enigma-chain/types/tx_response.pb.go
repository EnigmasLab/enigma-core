...
// source: enigma/types/v1beta1/tx_response.proto
...
func init() {
	proto.RegisterType((*TxResponseGenericMessage)(nil), "enigma.types.v1beta1.TxResponseGenericMessage")
	proto.RegisterType((*TxResponseData)(nil), "enigma.types.v1beta1.TxResponseData")
}

func init() {
	proto.RegisterFile("enigma/types/v1beta1/tx_response.proto", fileDescriptor_9122428102320deb)
}
