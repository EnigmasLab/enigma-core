...
// source: enigma/types/v1beta1/account.proto
...
func init() {
	proto.RegisterType((*EthAccount)(nil), "enigma.types.v1beta1.EthAccount")
}

func init() {
	proto.RegisterFile("enigma/types/v1beta1/account.proto", fileDescriptor_e25f61138fdc8ede)
}
...
var fileDescriptor_e25f61138fdc8ede = []byte{
	...
	0xc3, 0xca, 0xa9, 0x63, 0x81, 0x3c, 0xc3, 0x8c, 0x05, 0xf2, 0x0c, 0x2f, 0x16, 0xc8, 0x33, 0x9c,
	...
	0xff, 0xff, 0x96, 0xda, 0x34, 0x87, 0xda, 0x01, 0x00, 0x00,
}
