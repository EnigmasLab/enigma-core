...
import (
	...
	clicfg "github.com/EnigmasLab/enigma-core/cmd/enigmad/config/cli"
	"github.com/EnigmasLab/enigma-core/enigma-chain/app"
	enigmaclient "github.com/EnigmasLab/enigma-core/enigma-chain/client"
	"github.com/EnigmasLab/enigma-core/enigma-chain/crypto/hd"
	"github.com/EnigmasLab/enigma-core/version"
)
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig app.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		enigmaclient.KeyCommands(app.DefaultNodeHome),
		flags.LineBreak,
		rpc.StatusCommand(),
...
func (a appCreator) appExport(
	...
	if height != -1 {
		enigmaApp = app.NewEnigmaApp(logger, db, traceStore, false, map[int64]bool{}, homePath, uint(1), a.encCfg, appOpts)

		if err := enigmaApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		enigmaApp = app.NewEnigmaApp(logger, db, traceStore, true, map[int64]bool{}, homePath, uint(1), a.encCfg, appOpts)
	}

	return enigmaApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
