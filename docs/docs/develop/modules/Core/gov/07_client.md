...
```bash
enigmad query gov deposit [proposal-id] [depositer-addr] [flags]
```

Example:

```bash
enigmad query gov deposit 1 cosmos1..
```
...
```bash
enigmad query gov deposits [proposal-id] [flags]
```

Example:

```bash
enigmad query gov deposits 1
```
...
```bash
enigmad query gov param [param-type] [flags]
```

Example:

```bash
enigmad query gov param voting
```
...
```bash
enigmad query gov params [flags]
```

Example:

```bash
enigmad query gov params
```
...
```bash
enigmad query gov proposal [proposal-id] [flags]
```

Example:

```bash
enigmad query gov proposal 1
```
...
```bash
enigmad query gov proposals [flags]
```

Example:

```bash
enigmad query gov proposals
```
...
```bash
enigmad query gov proposer [proposal-id] [flags]
```

Example:

```bash
enigmad query gov proposer 1
```
...
```bash
enigmad query gov tally [proposal-id] [flags]
```

Example:

```bash
enigmad query gov tally 1
```
...
```bash
enigmad query gov vote [proposal-id] [voter-addr] [flags]
```

Example:

```bash
enigmad query gov vote 1 cosmos1..
```
...
```bash
enigmad query gov votes [proposal-id] [flags]
```

Example:

```bash
enigmad query gov votes 1
```
...
```bash
enigmad tx gov deposit [proposal-id] [deposit] [flags]
```

Example:

```bash
enigmad tx gov deposit 1 10000000stake --from cosmos1..
```
...
```bash
enigmad tx gov submit-proposal [command] [flags]
```

Example:

```bash
enigmad tx gov submit-proposal --title="Test Proposal" --description="testing, testing, 1, 2, 3" --type="Text" --deposit="10000000stake" --from cosmos1..
```

Example (`cancel-software-upgrade`):

```bash
enigmad tx gov submit-proposal cancel-software-upgrade --title="Test Proposal" --description="testing, testing, 1, 2, 3" --deposit="10000000stake" --from cosmos1..
```

Example (`community-pool-spend`):

```bash
enigmad tx gov submit-proposal community-pool-spend proposal.json --from cosmos1..
```
...
```bash
enigmad tx gov submit-proposal param-change proposal.json --from cosmos1..
```
...
```bash
enigmad tx gov submit-proposal software-upgrade v2 --title="Test Proposal" --description="testing, testing, 1, 2, 3" --upgrade-height 1000000 --from cosmos1..
```
...
```bash
enigmad tx gov vote [command] [flags]
```

Example:

```bash
enigmad tx gov vote 1 yes --from cosmos1..
```
...
```bash
enigmad tx gov weighted-vote [proposal-id] [weighted-options]
```

Example:

```bash
enigmad tx gov weighted-vote 1 yes=0.5,no=0.5 --from cosmos1
```
