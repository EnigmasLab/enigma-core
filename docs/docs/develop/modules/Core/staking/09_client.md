...
```bash
enigmad query staking delegation [delegator-addr] [validator-addr] [flags]
```

Example:

```bash
enigmad query staking delegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking delegations [delegator-addr] [flags]
```

Example:

```bash
enigmad query staking delegations cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
enigmad query staking delegations-to [validator-addr] [flags]
```

Example:

```bash
enigmad query staking delegations-to cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking historical-info [height] [flags]
```

Example:

```bash
enigmad query staking historical-info 10
```
...
```bash
enigmad query staking params [flags]
```

Example:

```bash
enigmad query staking params
```
...
```bash
enigmad q staking pool [flags]
```

Example:

```bash
enigmad q staking pool
```
...
```bash
enigmad query staking redelegation [delegator-addr] [src-validator-addr] [dst-validator-addr] [flags]
```

Example:

```bash
enigmad query staking redelegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking redelegations [delegator-addr] [flags]
```

Example:

```bash
enigmad query staking redelegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
enigmad query staking redelegations-from [validator-addr] [flags]
```

Example:

```bash
enigmad query staking redelegations-from cosmosvaloper1y4rzzrgl66eyhzt6gse2k7ej3zgwmngeleucjy
```
...
```bash
enigmad query staking unbonding-delegation [delegator-addr] [validator-addr] [flags]
```

Example:

```bash
enigmad query staking unbonding-delegation cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking unbonding-delegations [delegator-addr] [flags]
```

Example:

```bash
enigmad query staking unbonding-delegations cosmos1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
```
...
```bash
enigmad query staking unbonding-delegations-from [validator-addr] [flags]
```

Example:

```bash
enigmad query staking unbonding-delegations-from cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking validator [validator-addr] [flags]
```

Example:

```bash
enigmad query staking validator cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```
...
```bash
enigmad query staking validators [flags]
```

Example:

```bash
enigmad query staking validators
```
...
```bash
enigmad tx staking create-validator [flags]
```
...
```bash
enigmad tx staking delegate [validator-addr] [amount] [flags]
```

Example:

```bash
enigmad tx staking delegate cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey
```
...
```bash
enigmad tx staking edit-validator [flags]
```

Example:

```bash
enigmad tx staking edit-validator --moniker "new_moniker_name" --website "new_webiste_url" --from mykey
```
...
```bash
enigmad tx staking redelegate [src-validator-addr] [dst-validator-addr] [amount] [flags]
```

Example:

```bash
enigmad tx staking redelegate cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj cosmosvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100stake --from mykey
```
...
```bash
enigmad tx staking unbond [validator-addr] [amount] [flags]
```

Example:

```bash
enigmad tx staking unbond cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100stake --from mykey
```
