...
```bash
enigmad query upgrade applied [upgrade-name] [flags]
```
...
```bash
enigmad query upgrade applied "test-upgrade"
```
...
```bash
enigmad query upgrade module_versions [optional module_name] [flags]
```

Example:

```bash
enigmad query upgrade module_versions
```
